...
@php
    use Carbon\Carbon;
@endphp
<form wire:submit.prevent="approvePhieuXXDH">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if ($loaiDonHang == 'dht')
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="row mb-2">
                                                                <div class="col-6">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Nhập kiểu máy dệt" wire:model.defer="kieuMayDet.{{ $item->id }}" required>
                                                                </div>
                                                                <div class="col-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @foreach($inputs_khst as $key => $value)
                                            ...
                                            <div class="row mb-2 g-2">
                                                <div class="col-5">
                                                    <input type="text" class="form-control" placeholder="Quy cách" wire:model.defer="quyCachSuDungKHST.{{ $value }}" required>
                                                </div>
                                                <div class="col-3">
                                                    <input type="text" class="form-control" placeholder="Số lượng" wire:model.defer="soLuongKHST.{{ $value }}" required>
                                                </div>
                                                <div class="col-3">
                                                    <input type="text" class="form-control" placeholder="Lot" wire:model.defer="lotKHST.{{ $value }}" required>
                                                </div>
                                                <div class="col-1">
                    ...
                    @elseif ($status == 'KHST APPROVED' || $status == 'QA APPROVED')
                        <div class="row mb-3">
                            <div class="col">
                                <div class="card text-bg-light">
                                    <h5 class="card-header">Quy cách - Sale</h5>
                            ...
                            <div class="col">
                                <div class="shadow p-3 bg-body-tertiary rounded">
                                    <div class="row mb-2">
                                        <div class="col-8">
                                            <label for="soCone" class="form-label">Số cone</label>
                                            <input type="text" class="form-control" id="soCone" placeholder="Số cone" wire:model.defer="soCone" readonly>
                                        </div>
                                        <div class="col-4">
                                            <label for="soKgCone" class="form-label">Số kg/cone</label>
                                            <input type="text" class="form-control" id="soKgCone" placeholder="Số kg/cone" wire:model.defer="soKgCone" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            <label for="Line" class="form-label">Nơi sản xuất dự kiến - Line</label>
                                            <input type="text" class="form-control" id="Line" placeholder="Line" wire:model.defer="Line" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label for="May" class="form-label">Máy</label>
                                            <input type="text" class="form-control" id="May" placeholder="Máy" wire:model.defer="May" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            <label for="ngayGiaoHang" class="form-label">Ngày giao hàng</label>
                                            <input type="date" class="form-control" id="ngayGiaoHang" wire:model.defer="ngayGiaoHang" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label for="ngayBatDauGiao" class="form-label">Ngày bắt đầu giao (nếu có)</label>
                                            <input type="date" class="form-control" id="ngayBatDauGiao" wire:model.defer="ngayBatDauGiao" readonly>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label for="thanhPhamCuaKhachHang" class="form-label">Thành phẩm của khách hàng</label>
                                            <input type="text" class="form-control" id="thanhPhamCuaKhachHang" placeholder="Thành phẩm của khách hàng" wire:model.defer="thanhPhamCuaKhachHang" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                            ...
                            <div class="col">
                                <div class="shadow p-3 bg-body-tertiary rounded">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label class="form-label">QA kiến nghị</label>
                                            <textarea class="form-control" cols="30" rows="5" wire:model.defer="qaKienNghi" readonly></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-6">
                            ...
                            <div class="col">
                                <div class="shadow p-3 bg-body-tertiary rounded">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-4">
                                            <label class="form-label">Số kg/cone</label>
                                            <input type="text" class="form-control" placeholder="Số kg/cone" required wire:model.defer="soKgCone" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label class="form-label">QA kiến nghị</label>
                                            <input type="text" class="form-control" required wire:model.defer="QA kiến nghị" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-6">
