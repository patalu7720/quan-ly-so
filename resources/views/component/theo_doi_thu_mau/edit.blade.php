              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    @if ($state == 'edit')
                        ...
                        @elseif ($theoDoiThuMauModel['status'] == 'SM đã duyệt')
                            <div class="col-12">
                                <label class="form-label">QA kiến nghị</label>
                                <textarea name="" id="" cols="30" rows="5" class="form-control form-control-sm" placeholder="Nhập kiến nghị" wire:model.defer="theoDoiThuMauModel.qa_kien_nghi"></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Thông số KT</label>
                                <textarea name="" id="" cols="30" rows="5" class="form-control form-control-sm" placeholder="Nhập thông số KT" wire:model.defer="theoDoiThuMauModel.thong_so_ky_thuat"></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Kết quả dệt vớ</label>
                                <textarea name="" id="" cols="30" rows="5" class="form-control form-control-sm" placeholder="Nhập kết quả dệt vớ" wire:model.defer="theoDoiThuMauModel.ket_qua_det_vo"></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Kết quả dệt vải</label>
                                <textarea name="" id="" cols="30" rows="5" class="form-control form-control-sm" placeholder="Nhập kết quả dệt vải" wire:model.defer="theoDoiThuMauModel.ket_qua_det_vai"></textarea>
                            </div>
                        @endif
                    @else
