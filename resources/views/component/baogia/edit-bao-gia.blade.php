...
<form wire:submit.prevent="updateBaoGia">
    <div class="row">
      <div class="col">
        <div wire:ignore.self class="modal" id="editBaoGiaModal" data-bs-backdrop="static" tabindex="-1">
          <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Cập nhật phiếu Báo Giá - {{ $soPhieu }}</h5>
                ...
                <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="ndEdit" value="nd" wire:model.defer="loaiBaoGia">
                                            <label class="form-check-label" for="ndEdit">
                                                Nội địa
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="xkEdit" value="xk" wire:model.defer="loaiBaoGia">
                                            <label class="form-check-label" for="xkEdit">
                                                Xuất khẩu
                                            </label>
                                        </div>
                                    </div>
                    ...
                    @if ($baoGiaSanPham != null)

                        @foreach ($baoGiaSanPham as $item)
                            <div class="row">
                                <div class="col-12">
                                    <div class="shadow p-3 mb-3 bg-body-tertiary rounded">
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-2 g-2">
                                                    <div class="col-4">
                                                        <select class="form-select" aria-label="Default select example" wire:model.defer="yarnType1Edit.{{ $item->id ?? $item['id'] }}">
                                                            <option>--- No item select ---</option>
                                                    ...
                                                    <div class="col-4">
                                                        <select class="form-select" aria-label="Default select example" wire:model.defer="yarnType2Edit.{{ $item->id ?? $item['id'] }}">
                                                    ...
                                                    <div class="col-4">
                                                        <input type="text" class="form-control" placeholder="Nhập Denier" wire:model.defer="yarnType3Edit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                    <div class="col-4">
                                                        <input type="text" class="form-control" placeholder="Filament" wire:model.defer="yarnType4Edit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                    <div class="col-4">
                                                        <select class="form-select" aria-label="Default select example" wire:model.defer="yarnType5Edit.{{ $item->id ?? $item['id'] }}">
                                                            <option>--- No select ---</option>
                                                    ...
                                                    <div class="col-4">
                                                        <select class="form-select" aria-label="Default select example" wire:model.defer="yarnType6Edit.{{ $item->id ?? $item['id'] }}">
                                                            <option>--- No select ---</option>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập OEM (nếu có)" wire:model.defer="oemEdit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row g-2">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập Quantity" required wire:model.defer="quantityEdit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="form-label">Bobbin Weight</label>
                                                        <input type="text" class="form-control" placeholder="Nhập Bobbin Weight" required wire:model.defer="bobbinWeightEdit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="form-label">Yarn Price</label>
                                                        <input type="text" class="form-control" placeholder="Nhập Yarn Price" required wire:model.defer="yarnPriceEdit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="form-label">Grade</label>
                                                        <input type="text" class="form-control" placeholder="Nhập Grade" required wire:model.defer="gradeEdit.{{ $item->id ?? $item['id'] }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div class="row p-2">
                                            <div class="col-1">
                                                <button class="btn btn-outline-danger btn-sm float-end"  style="margin-top: 3px" wire:click.prevent="removeBaoGiaSanPham({{ $key }})"><i class="fa-regular fa-trash-can"></i></button>
                                            </div>
                                        </div> --}}
                                    </div>
                                </div>
