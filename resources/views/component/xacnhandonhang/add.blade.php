<form wire:submit.prevent="addXNDH">
    <div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="addXNDHModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tạo phiếu XNĐH</h1>
                    ...
                    @if ($state == 'add')
                        ...
                        <div class="shadow p-3 mb-3 bg-body-tertiary rounded">
                            ...
                            <div class="row mb-2 g-2">
                                <div class="col-7">
                                    <input type="text" class="form-control" placeholder="Quy cách" required wire:model.defer="quyCach.0" required>
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Số lượng" required wire:model.defer="soLuong.0" required>
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Đơn giá" required wire:model.defer="donGia.0" required>
                                </div>
                            </div>
