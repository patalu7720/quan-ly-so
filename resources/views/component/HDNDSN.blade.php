...
<form wire:submit.prevent="{{$this->formSubmit}}">
    <div>
        <div wire:ignore.self class="modal fade" data-bs-backdrop="static"  id="ModalNDSNTV" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-fullscreen">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fa-sharp fa-solid fa-folder-plus" style="color:forestgreen"></i>{{ $this->formSubmit ==  'storeHopDongNoiDiaSongNgu' ? '    Tạo HĐ - Nội Địa Song Ngữ - Tiếng Việt' : '    Sửa HĐ - Nội Địa Song Ngữ - Tiếng Việt' }}</h1>
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="Nhập số TDG/TTĐH" wire:model.defer="soTDG">
                                        </div>
                                    </div>
                                    <div class="row g-2">
                                        <div class="col-12">
                                ...
                                <div class="card-body">
                                    <div class="row g-2">
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Nhập tên khách hàng" wire:model.defer = "benb" wire:change="{{ $this->formSubmit == 'updateHopDongNoiDiaSongNgu' ? 'timthongtinbenbEdit()' : 'timthongtinbenb()' }}" required>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" wire:model.defer="soLuong_1_10" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" cols="30" rows="5" wire:model.defer="chatluong" placeholder="Nhập chất lượng"></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <input type="{{ $chatluong == 'Khác' ? 'text' : 'hidden' }}" class="form-control" placeholder="Chất lượng khác" wire:model.defer="chatluongkhac" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                ...
                <div class="modal-footer">
                  ...
                  <button class="btn btn-primary" data-bs-target="#ModalNDSNTA" wire:click.prevent = "" data-bs-toggle="modal">Tiếp tục <i class="fa-sharp fa-solid fa-arrow-right"></i></button>
                </div>
              </div>
            </div>
        </div>
        <div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="ModalNDSNTA" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="card text-bg-light mb-3">
                            <h5 class="card-header">Bên B - Tiếng Anh</h5>
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-12">
                                        <label for="exampleDataList" class="form-label">Khách hàng</label>
                                    ...
                                    <div class="col-12 col-lg-12">
                                        <label for="inputTaiKhoanSoKhachHang" class="form-label">Tài khoản ngân hàng</label>
                                        <textarea cols="30" rows="2" class="form-control" placeholder="Tài khoản ngân hàng - Tiếng Anh" wire:model.defer="taikhoansobenb_ta"></textarea>
                                    </div>
                                    {{-- <div class="col-12 col-lg-6">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card text-bg-light mb-3">
                            <h5 class="card-header">Thông tin chi tiết - Tiếng Anh</h5>
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-12">
                                        <label for="inputChatLuong" class="form-label">Chất lượng</label>
                ...
                <div class="modal-footer">
                  <button class="btn btn-secondary" data-bs-target="#ModalNDSNTV" wire:click.prevent = "" data-bs-toggle="modal">Quay lại <i class="fa-solid fa-arrow-left-long"></i></button>
