<form action="" wire:submit.prevent="createTDGNewVersion">
    <div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="createTDGNewVersionModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
