<div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="createTDGModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Tạo TDG</h1>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="mb-3">
                        <label class="form-label">Số phiếu Xác nhận đơn hàng</label>
                        <input type="text" class="form-control" placeholder="Nhập số phiếu Xác nhận đơn hàng" wire:model.defer="soPhieuXacNhanDonHang">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" wire:click="createTDG">Thực hiện</button>
        </div>
      </div>
    </div>
</div>