<div class="container" style="margin-top: 10px">
    ...
    @include('component.xacnhandonhang.add')
    @include('component.xacnhandonhang.approve')
    @include('component.xacnhandonhang.rollback')
    @include('component.xacnhandonhang.detail')
        ...
        <div class="col">
            <div class="shadow p-3 mb-3 bg-body-tertiary rounded">
                <div class="row">
                    ...
                    @can('create_xac_nhan_don_hang')
                        <div class="col-12 col-lg-3">
                            <button class="btn btn-primary float-end" data-bs-toggle="modal" wire:click="addXNDHModal" data-bs-target="#addXNDHModal">+ Thêm mới</button>
                        </div>
                    @endcan
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="dropdown dropend float-end">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        @if ($item->status == 'New')
                                                            @if ($item->loai == 'nd')
                                                                @can('approve_1_xac_nhan_don_hang')
                                                                    <li><a class="dropdown-item fw-bolder" wire:click="approveXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#approveXNDHModal"><i class="fa-solid fa-check-double"></i> Approve</a></li>
                                                                    <li><a class="dropdown-item" wire:click="rollbackXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#rollbackXNDHModal"><i class="fa-solid fa-rotate-left"></i> Roll Back</a></li>
                                                                @endcan
                                                            @else
                                                                @can('approve_2_xac_nhan_don_hang')
                                                                    <li><a class="dropdown-item fw-bolder" wire:click="approveXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#approveXNDHModal"><i class="fa-solid fa-check-double"></i> Approve</a></li>
                                                                    <li><a class="dropdown-item" wire:click="rollbackXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#rollbackXNDHModal"><i class="fa-solid fa-rotate-left"></i> Roll Back</a></li>
                                                                @endcan
                                                            @endif
                                                        ...
                                                        @elseif ($item->status == 'Approved 1')
                                                            ...
                                                            @endif
                                                        @elseif ($item->status == 'Approved 2')
                                                            @can('approve_3_xac_nhan_don_hang')
                                                                <li><a class="dropdown-item fw-bolder" wire:click="approveXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#approveXNDHModal"><i class="fa-solid fa-check-double"></i> Approve</a></li>
                                                                <li><a class="dropdown-item" wire:click="rollbackXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#rollbackXNDHModal"><i class="fa-solid fa-rotate-left"></i> Roll Back</a></li>
                                                            @endcan
                                                        @elseif ($item->status == 'Finish')
                                                            ...
                                                            @endrole
                                                        @endif
                                                        <li><a class="dropdown-item" wire:click="detailXNDHModal('{{ $item->so_phieu }}')" data-bs-toggle="modal" data-bs-target="#detailXNDHModal"><i class="fa-solid fa-eye"></i> Xem Chi tiết</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
